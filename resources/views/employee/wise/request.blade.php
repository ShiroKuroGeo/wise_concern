...
<body>
                ...
                <div class="col-xl-6">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body">
                            <form action="{{ route('store-wise-request') }}" class="form-horizontal" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                <div class="form-group row mb-3">
                                    <label class="col-lg-4 col-form-label form-label" for="fullname">Department * :</label>
                                    <div class="col-lg-8">
                                        <input class="form-control border-0" readonly type="text" id="department" value="{{ $data }}" name="department" placeholder="{{ $data }}" />
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" type="text" id="email" name="email" data-parsley-type="email" placeholder="Email" />
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    <label class="col-lg-4 col-form-label form-label" for="message">Concern :</label>
                                    <div class="col-lg-8 custom-select-wrapper">
                                        <select name="concern" id="concern" class="form-select custom-select">
                                            <option selected hidden>Select Type of Concern</option>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="assignedto" name="assignedto" value="Sir John"></input>
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
    ...
    <script src="{{ asset('js/jquery.gritter.js') }}" type="9dd2961859eb1e28de60110d-text/javascript"></script>
