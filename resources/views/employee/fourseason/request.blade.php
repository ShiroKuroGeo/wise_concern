                ...
                <div class="col-xl-6">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Application for Concern</h4>
                        ...
                        <div class="panel-body">
                            <form action="{{ route('ticket-store-fourseason') }}" class="form-horizontal" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-8 d-flex">
                                        <div class="form-check me-3">
                                            <input class="form-check-input" type="checkbox" name="priority" id="easyPriority" value="East" onchange="handleCheckboxChange('easyPriority')">
